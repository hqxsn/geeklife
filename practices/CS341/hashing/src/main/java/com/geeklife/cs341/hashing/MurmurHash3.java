 ...
 */
public class MurmurHash3 implements Hash32, Hash64 {

    @Override
    public int hash(byte[] data, long seed) {
        return MurmurHash3_x64_32(data, HASHING.HASHING_SEED);
    }

    @Override
    public long hash64(byte[] data, long seed) {
        return MurmurHash3_x64_64(data, HASHING64.HASHING_SEED);
    }
     ...
     */
    public long MurmurHash3_x64_64(final byte[] key, final int seed) {
     ...
     */
    public int MurmurHash3_x64_32(final byte[] key, final int seed) {
